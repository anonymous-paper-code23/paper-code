...
class Preprocessor(ABC):
    ...
    def __init__(self, wrapper, task_name, pattern_id: int = 0, verbalizer_file: str = None, label_dict: dict = None):
        """
        ...
        self.pvp = PVPS[task_name](self.wrapper, pattern_id, verbalizer_file, label_dict)  # type: PVP
