...
DATA_PATH = {
    'snopes':'Snopes',
    'perspectrum':'PERSPECTRUM',
    'argmin':'ArgMin',
    'ibmcs':'IBM_CLAIM_STANCE',
    'iac1':'IAC',
    'fnc1':'FNC-1',
    'arc':'ARC',
    'semeval2016t6':'SemEval2016Task6',
    'semeval2019t7':'SemEval2019Task7',
}

# ['argmin', 'arc', 'fnc1', 'iac1', 'ibmcs', 'perspectrum', 'semeval2016t6', 'semeval2019t7', 'snopes']
...
# dataset label 不要改
dataset_dict = {
    'snopes':{'0':'refute','1':'agree'},
    'perspectrum':{'0':'UNDERMINE','1':'SUPPORT'},
    'argmin':{'0':'Argument_against','1':'Argument_for'},
    'ibmcs':{'0':'CON','1':'PRO'},
    'iac1':{'0':'anti','1':'pro','2':'other'},
    'fnc1':{'0':'unrelated','1':'discuss','2':'agree','3':'disagree'},
    'arc':{'0':'unrelated','1':'discuss','2':'agree','3':'disagree'},
    'semeval2016t6':{'0':'AGAINST','1':'FAVOR','2':'NONE'},
    'semeval2019t7':{'0':'support','1':'deny','2':'query','3':'comment'},
}
...
print(verbalizer_token_max.shape)
