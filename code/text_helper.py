...
if __name__ == "__main__":
    ...
    For testing
    """
    data_path = '/root/NLPCODE/Stance_Detection/Resource/code/mdl-stance-robustness/data/mt_dnn/'

    dataset_name = 'argmin'

    corpus_path = data_path + dataset_name + '_train.json'

    corpus_save_path = data_path + dataset_name + '_corpus.json'
    corpus_i = []
    premise = []
    label = []
    with open(corpus_path, 'r') as corpus_data:
