...
def load_pet_configs(args) -> Tuple[WrapperConfig, pet.TrainConfig, pet.EvalConfig]:
    ...
    train_cfg = pet.TrainConfig(device=args.device, per_gpu_train_batch_size=args.pet_per_gpu_train_batch_size,
                                ...
                                logging_steps=args.logging_steps, alpha=args.alpha)
...
def load_sequence_classifier_configs(args) -> Tuple[WrapperConfig, pet.TrainConfig, pet.EvalConfig]:
    ...
    train_cfg = pet.TrainConfig(device=args.device, per_gpu_train_batch_size=args.sc_per_gpu_train_batch_size,
                                ...
                                temperature=args.temperature, logging_steps=args.logging_steps,
...
def main():
    ...
    # Required parameters
    parser.add_argument("--method", required=True, choices=['pet'],
    ...
    parser.add_argument("--pet_num_train_epochs", default=4, type=float,
    ...
    parser.add_argument("--sc_per_gpu_train_batch_size", default=16, type=int,
    ...
    parser.add_argument("--sc_per_gpu_unlabeled_batch_size", default=16, type=int,
    ...
    parser.add_argument("--sc_num_train_epochs", default=4, type=float,
    ...
    # test = load_examples(
    #     '2016t6', './GLUE_data/SemEval2016Task6/', UNLABELED_SET, num_examples=1000)
    # for i in test:
    #     print(i)
